...
const Share = () => {
    return (
        <div className='px-[37px] pb-[28px] pt-[15px] bg-white dark:bg-darkBg rounded-xl'>
            <div className='flex items-center gap-[10px]'>
                <div>
                    <img className='w-[55px] h-[55px]  rounded-full ' src={photo} />
                </div>
                <div>
                    <input placeholder='Write...' className='border border-[#E5E5E5] dark:bg-darkButtonBg dark:text-white dark:border-none py-[9px] px-[15px] md:w-[100px] lg:w-[300px] xl:w-[400px] placeholder:text-base rounded-3xl outline-none' />
                </div>
                <div>
            ...
            <div className='flex items-center justify-center gap-[20px] mt-[14px]'>
